...
int main(int argc, char **argv)
{
  ...
  if (imu_data.linear_acceleration.x !=0 && imu_data.linear_acceleration.y !=0 && mocap_data.pose.position.x != 0 && mocap_data.pose.position.y != 0 && force_data.force.x != 0 && force_data.force.z != 0){
